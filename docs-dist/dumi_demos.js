                            ...
                            (u = function() {
                              ...
                              return (
                                ...
                                l['default'].createElement(
                                  l['default'].Fragment,
                                  null,
                                  l['default'].createElement(i.FormTable, {
                                    onRef: function(n) {
                                      return (e.current = n);
                                    },
                                    columns: u,
                                ...
                                l['default'].createElement(
                                  ...
                                  l['default'].createElement(
                                    ...
                                    l['default'].createElement(
                                      ...
                                      l['default'].createElement(s.Input, null),
                                    ),
                                    l['default'].createElement(i.FormTable, {
    ...
    ngFD: function(e, n, t) {
        ...
        if (null != t) {
          ...
          try {
            for (t = t.call(e); !(l = (a = t.next()).done); l = !0)
              if ((o.push(a.value), n && o.length === n)) break;
          } catch (i) {
            (s = !0), (r = i);
          } finally {
            try {
      ...
      var h = function(e) {
        var n,
          ...
          h = Object(s['useDemoUrl'])(p.identifier),
          y = p.demoUrl || h,
          v =
            (null === l['a'] || void 0 === l['a']
              ? void 0
              : l['a'].location.hash) === '#'.concat(p.identifier),
          ...
          O = I[0],
          D = I[1],
          B = Object(a['useState'])(b(O, p.sources[O])),
          N = u(B, 2),
          V = N[0],
          _ = N[1],
          ...
          U = L[0],
          H = L[1],
          A = Object(a['useState'])(Math.random()),
          M = u(A, 2),
          Y = M[0],
          z = M[1],
          K = p.sources[O][V] || p.sources[O].content,
            ...
            U &&
              r.a.createElement(
                ...
                r.a.createElement(
                  ...
                  r.a.createElement(i['a'], { code: K, lang: V, showCopy: !1 }),
                ),
              ),
          )
        );
    ...
    'q/9g': function(e, n, t) {
      ...
      var u = function(e, n) {
        var t = [],
          ...
          l = void 0 === e.location.query.wrapper,
          i = n[o];
        if (i) {
          var u = s(
            s({}, i.previewerProps),
            {},
            {
              hideActions: (i.previewerProps.hideActions || []).concat([
                'EXTERNAL',
              ]),
            },
          );
                  ...
                  a()['default'].createElement(function() {
                    return (
                      ...
                      a()['default'].createElement(
                        'div',
                        {},
                        a()['default'].createElement(i.component),
                      )
                    );
                  }),
                ]
              : [u, a()['default'].createElement(i.component)]);
        }
        return t;
      };
      n['default'] = u;
