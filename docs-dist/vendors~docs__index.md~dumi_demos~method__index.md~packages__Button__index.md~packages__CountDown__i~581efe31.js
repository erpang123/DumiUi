    ...
    I3GT: function(e, t, n) {
                      ...
                      for (
                        ...
                        if (!(k instanceof l)) {
                          if (b && E != n.length - 1) {
                            ...
                            if (!w) break;
                            for (
                              var v = w.index + (f ? w[1].length : 0),
                                A = w.index + w[0].length,
                                T = E,
                                I = S,
                                _ = n.length;
                              T < _ &&
                              (I < A || (!n[T].type && !n[T - 1].greedy));
                              ++T
                            )
                              (I += n[T].length), v >= I && (++E, (S = I));
                            if (n[E] instanceof l) continue;
                            (O = T - E), (k = e.slice(S, I)), (w.index -= S);
                          } else {
                            d.lastIndex = 0;
                            w = d.exec(k);
                            var O = 1;
      ...
      var d = /\r\n|\r|\n/,
        ...
        m = function(e, t) {
          ...
          return (
            (r.root = n), (r.plain = p({}, n, { backgroundColor: null })), r
          );
        };
      function h(e, t) {
        var n = {};
            ...
            e.apply(this, n),
              ...
              c(this, 'getLineProps', function(e) {
                ...
                return (
                  ...
                  void 0 !== r &&
                    (o.style = void 0 !== o.style ? p({}, o.style, r) : r),
                  void 0 !== n && (o.key = n),
                  a && (o.className += ' ' + a),
                  o
                );
              ...
              c(this, 'getTokenProps', function(e) {
                ...
                return (
                  void 0 !== r &&
                    (l.style = void 0 !== l.style ? p({}, l.style, r) : r),
                  void 0 !== n && (l.key = n),
                  a && (l.className += ' ' + a),
                  l
                );
