...
export default (props: any) => {
  const { startTime = 60, onClick, disabled, defaultText = '获取验证码', unit = 's' }: PropFace = props
  ...
  return (
    <div className='count-down'>
      <Button type="primary" disabled={disabled || nowCount !== defaultText} onClick={codeMath}>{nowCount}{nowCount !== defaultText ? unit : ''}</Button>
    </div>
  )
}
